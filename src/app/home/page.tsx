        ...
        <section className="faq-section">
          ...
          <div className="faq-container">
            <details>
              ...
              The primary goal of the Mars Rover project is to explore the
              surface of Mars, study its geology, atmosphere, and potential for
              past or present life, and gather data that will help prepare for
            ...
            <details>
              ...
              allow it to move across Mars&apos; terrain. Using cameras,
              sensors, and GPS-like navigation, it can avoid obstacles, select
              the best paths, and conduct scientific missions with minimal input
              from Earth.
            </details>
            <details>
